...
(function (window) {
  const getDynamicConfig = () => {
    ...
    return {
      ...
      BOARD_NO: '4',
      EFAULT_IMG: '//img.echosting.cafe24.com/thumb/img_product_medium.gif',
